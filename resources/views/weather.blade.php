<x-layout>
    <div class="container mx-auto px-4 py-12">
        ...
        <h1 class="text-6xl font-extrabold mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-pink-300 dark:from-blue-300 dark:to-pink-200">Weather API</h1>

            <h2 class="text-3xl font-semibold mb-6 text-white dark:text-gray-200">Usage Guide</h2>
            <p class="text-xl text-white/90 dark:text-gray-300 mb-8">Get accurate weather data with our powerful API. Here's how to get started:</p>
            ...
            <div class="space-y-12">
                <section>
                    ...
                    <p class="text-white/90 dark:text-gray-300 mt-4">This request will return weather data for London, UK.</p>
                </section>
                        ...
                        <pre class="text-green-300 dark:text-green-400 text-sm overflow-x-auto">
{
    ...
    "timestamp": "YYYY-MM-DD HH:MM:SS"
                ...
                <section>
                    ...
                    <p class="text-white/90 dark:text-gray-300">This request will return weather data for London, UK, in metric units, with a 3-day forecast.</p>
                </section>
