<x-layout>
    <div class="text-center py-24">
        ...
        <h1 class="text-5xl md:text-7xl font-headline font-extrabold tracking-tighter text-on-surface leading-none mb-2">
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-tertiary">403</span>
        </h1>
        <p class="font-headline font-bold text-on-surface text-lg uppercase tracking-widest mb-4">Access Denied</p>
        <p class="text-on-surface-variant text-sm mb-10">You don't have permission to access this resource.</p>
