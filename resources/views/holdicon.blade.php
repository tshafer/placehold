<x-layout>
    <div class="container mx-auto px-4 py-12">
        <h1 class="text-6xl font-extrabold mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-pink-300">Holdicon API Documentation</h1>
        ...
        <div class="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-8 rounded-2xl shadow-lg bg-no-repeat bg-cover">
            ...
            <p class="text-xl text-white/90 mb-8">Create custom placeholder images with our powerful Holdicon API. Here's how to get started:</p>

            <div class="space-y-12">
                <section>
                    <h3 class="text-2xl font-semibold mb-4 text-white">Endpoint</h3>
                    <div class="bg-black/30 p-4 rounded-lg">
                        <code class="text-green-300 text-sm break-all">
                            GET {{ route('holdicon') }}
                        </code>
                    </div>
                    <p class="text-white/90 mt-4">This API generates customizable placeholder images with optional text, icons, or animal shapes.</p>
                </section>
                ...
                <section>
                    ...
                    <p class="text-white/90 mb-4">Generate a 200x200 image with red background and white text "AB":</p>
                    ...
                    <p class="text-white/90 mb-4">Generate a 150x150 robot icon with default colors:</p>
                    <div class="bg-black/30 p-4 rounded-lg mb-4">
                        <code class="text-green-300 text-sm break-all">
                    ...
                    <p class="text-white/90 mb-4">Generate a 180x180 cat icon with custom colors:</p>
                    <div class="bg-black/30 p-4 rounded-lg mb-4">
                        <code class="text-green-300 text-sm break-all">
                ...
                <section>
                    <h3 class="text-2xl font-semibold mb-4 text-white">Response</h3>
                    <p class="text-white/90 mb-4">The API returns a PNG image.</p>
                </section>

                <section>
                    <h3 class="text-2xl font-semibold mb-4 text-white">Rate Limiting</h3>
                    <p class="text-white/90 mb-4">This endpoint is rate-limited to 120 requests per minute.</p>
                </section>
            </div>
        </div>
    </div>
