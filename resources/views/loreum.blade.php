<x-layout>
    <div class="container mx-auto px-4 py-12">
        <h1 class="text-6xl font-extrabold mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-pink-300">Lorem Ipsum Generator API</h1>
        ...
        <div class="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-8 rounded-2xl shadow-lg bg-no-repeat bg-cover">
            ...
            <p class="text-xl text-white/90 mb-8">Generate custom Lorem Ipsum text with our powerful API. Here's how to get started:</p>
            ...
            <div class="space-y-12">
                <section>
                    ...
                    <p class="text-white/90 mt-4">This will generate 3 paragraphs of Lorem Ipsum text by default.</p>
                </section>

                <section>
                    <h3 class="text-2xl font-semibold mb-4 text-white">Parameters</h3>
                ...
                <section>
                    <h3 class="text-2xl font-semibold mb-4 text-white">Example</h3>
                    ...
                    <p class="text-white/90 mt-4">This will generate 2 paragraphs, each containing 10-15 words, in HTML format, without capitalization but with punctuation.</p>
                </section>

                <section>
                    <h3 class="text-2xl font-semibold mb-4 text-white">Response Format</h3>
                    <p class="text-white/90 mb-4">The API returns a JSON response with the following structure:</p>
                    <pre class="bg-black/30 p-4 rounded-lg text-green-300 text-sm">
{
    "status": "success",
    ...
    "metadata": {
        ...
        "seed": 12345
                ...
                <section>
                    ...
                    <p class="text-white/90 mb-4">If an error occurs, the API will return a JSON response with an error message:</p>
                    <pre class="bg-black/30 p-4 rounded-lg text-green-300 text-sm">
{
    "status": "error",
    "message": "An error occurred: [Error message]"
                ...
                <section>
                    ...
                    <p class="text-white/90 mb-4">The API is rate-limited to 120 requests per minute to ensure fair usage.</p>
                </section>
            </div>
        </div>
    </div>
